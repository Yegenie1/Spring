...
public class MemberController {
	...
	// 써주어야 한다.
	/*
	 * @RequestMapping("login") public String login(MemberVO bag) {
	 * 
	 * System.out.println("login요청됨."); System.out.println(bag);
	 * 
	 * int result = dao.login(bag); if (result==1) { return "ok"; } else { return
	 * "redirect:member.jsp";//redirect view아래가 아니라 webapp아래의 파일로 가고싶은 경우 } }
	 */
	...
	@RequestMapping("one2")
	@ResponseBody
	public MemberVO one2(String id) {
		System.out.println("one요청됨.");
		System.out.println(id);
		MemberVO bag = dao.one(id);
